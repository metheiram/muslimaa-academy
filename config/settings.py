...
# Email Configuration
CONTACT_EMAIL = os.getenv('CONTACT_EMAIL', 'metheiraam@gmail.com')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Muslimaa Academy <noreply@muslimaaacademy.com>')
